...
- **OpenCV 4.10.0**: Библиотека для компьютерного зрения и обработки изображений (используется для получения изображения с видеокамеры устройства и тестирования).
